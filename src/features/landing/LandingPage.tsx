...
export const LandingPage = () => {
    return (
        <div className="h-screen w-screen overflow-hidden bg-black text-white flex flex-col items-center justify-center relative selection:bg-indigo-500/30">
            ...
            <header className="absolute top-0 w-full p-8 flex justify-center items-center z-20">
                <motion.h1
            ...
            <main className="flex flex-col items-center z-10 relative px-4 text-center">
                ...
                >
                    <div className="absolute -inset-1 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-full blur opacity-25 animate-pulse"></div>
                ...
                <motion.h2
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.8, delay: 0.2 }}
                    className="text-7xl md:text-9xl font-black tracking-tighter mb-4 pb-4 bg-clip-text text-transparent bg-gradient-to-b from-white via-white to-white/40"
                >
                    Allify
                </motion.h2>
                ...
                >
                    <button className="group relative px-8 py-4 rounded-full bg-white text-black font-bold text-lg hover:pr-10 transition-all duration-300 shadow-[0_0_20px_-5px_rgba(255,255,255,0.3)] hover:shadow-[0_0_25px_-5px_rgba(255,255,255,0.5)] overflow-hidden cursor-pointer">
                    ...
                    <button className="px-8 py-4 rounded-full border border-white/20 text-white font-semibold text-lg hover:bg-white/5 hover:border-white/40 transition-all duration-300 backdrop-blur-sm cursor-pointer">
                        Log in
                    </button>
                </motion.div>
            </main>
