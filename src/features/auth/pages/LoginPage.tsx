...
export const LoginPage = () => {
    ...
    return (
        <div className="min-h-[100svh] md:h-[100dvh] w-full bg-black text-white relative selection:bg-indigo-500/30 md:overflow-hidden overflow-x-hidden pt-[max(env(safe-area-inset-top),16px)] md:pt-0 pb-[env(safe-area-inset-bottom)]">
