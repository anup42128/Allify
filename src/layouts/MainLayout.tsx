...
export const MainLayout = () => {
    ...
    return (
        <>
            ...
            <div className={`relative h-[100dvh] w-full md:h-screen md:w-screen bg-black overflow-hidden flex font-sans pt-[env(safe-area-inset-top)] ${!isAppReady ? 'opacity-0' : 'opacity-100'}`}>
                {/* Fixed Navigation */}
                <Sidebar />
